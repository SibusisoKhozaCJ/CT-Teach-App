export default [
  `
    <div class="swiper-slide bg-aqua2 swiper-slide-active" id="intro_tour01">
      <div>
      </div>
        <p class="slide-header h2 mb-4  ">THE TOUR</p>
        <p class="h1 mb-3 ">Hey there,...</p>
        <p class="h3 mb-4 ">So glad you’re here.</p>
        <p class="mb-4 w-75 text-center mx-auto"><img class="w-30 swiper-lazy swiper-lazy-loaded" alt="" src="/img/emoji/72/grinning-face-with-smiling-eyes.png"></p>
  ...
  `,
  `
    <div class="swiper-slide bg-aqua2 swiper-slide-next" id="intro_tour02">
      <div>
      </div>
      <div>
        ...
        <p class="mb-4 text-center mx-auto"><img class="w-50 swiper-lazy swiper-lazy-loaded" alt="" src="/img/tour/Intro-Briefing.jpg"></p>
  ...
  `
    <div class="swiper-slide bg-aqua2" id="intro_tour03">
      ...
      <div>
        ...
        <p class="mb-4 text-center mx-auto"><img class="w-50 swiper-lazy swiper-lazy-loaded" alt="" src="/img/tour/Intro-Challenge.jpg"></p>
  ...
  `
    <div class="swiper-slide bg-aqua2" id="intro_tour04">
      ...
      <div>
        ...
        <p class="mb-4 text-center mx-auto"><img class="w-50 swiper-lazy swiper-lazy-loaded" alt="" src="/img/tour/Intro-Editor.jpg"></p>
  ...
  `
    <div class="swiper-slide bg-aqua2" id="intro_tour05">
      ...
      <div>
        ...
        <p class="mb-4 text-center mx-auto"><img class="w-50 swiper-lazy swiper-lazy-loaded" alt="" src="/img/tour/Intro-Preview.jpg"></p>
  ...
  `
    <div class="swiper-slide bg-aqua2" id="intro_tour06">
      ...
      <div>
        ...
        <p class="mb-4 w-75 text-center mx-auto"><img class="w-30 swiper-lazy swiper-lazy-loaded" alt="" src="/img/emoji/72/thinking-face.png"></p>
...
//      <div class="arrow">
//        <img class="swiper-lazy swiper-lazy-loaded" alt="" src="/img/tour/down-scroll.png">
//     </div>
