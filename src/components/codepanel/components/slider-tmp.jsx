...
import Lesson from "../data/simple_example";
      ...
      >
        {lesson.slides.map((slide, slideNumber) => {
          return (
            ...
            >
              <ReflexElement
                className={`${classes.reflex} `}
                flex={1}
                style={{ height: "100%" }}
              >
                <div
                  className={`${classes.slideContainer} slide__wrapper slide__${slide.type}`}
