//P1Training4
const lesson_dataC0001P001T004 = {
  defaultCode: ``,
  kbLayout: "", 
  loadJS: "", 
  prevLessonID: "", 
  ...
  pageKeywords:
    "coding, code, training 4, learn to code, code website, my first website",
  pageTitle: "CodeJIKA - Project 1 Training 4",
  save_lesson_id: "P1Training4", 
  cert_awarded_at: 5, 
  slug: "", 
  show_intro: true,
  ...
  slides: [
    {
     ...
     /*  reg: [
      ...
      <div class='my-auto'>
        ...
        this!</p>
        <img class='mb-4 w-20 swiper-lazy' src='/img/emoji/72/grinning-face-with-star-eyes.png' alt=''>
      </div>   
    `,
    ...
    <div class="my-auto">
      ...
      <img class='w-20 my-auto swiper-lazy' src='/img/lessons/C001-P001-T004/div-suitcase.png' alt=''> 
    </div>
      `,
      //sort_order: 6,
      updated_at: "2017-09-28T16:09:40.256Z",
    ...
    },
    {
      ...
      tip: "Open it before h1 tags and Close it after p closing tags</li>",
      updated_at: "2017-09-28T16:09:40.256Z",
    },
    {
      slide_number: 9,
      ...
      `,
      //sort_order: 15,
      tip:" If you’re stuck, there's a Checkpoint after the next Challenge.",
      updated_at: "2017-09-28T16:09:40.256Z",
    },
    {
      slide_number: 10,
    ...
    },
    {
      ...
      html_content: `
      <div class="my-auto">
        <p class='h2 green pb-5 bold'><strong>GREAT!<strong></p>
        <img class='swiper-lazy' src='/img/emoji/72/person-raising-both-hands-in-celebration-type-5.png' alt=''> 
      </div>
    `,
      //sort_order: 22,
      updated_at: "2017-09-28T16:09:40.256Z",
    ...
    },
    {
      ...
      html_content: `
      <div class="my-auto">
      <p class='h2 green pb-5 bold'><strong>HMMM...</strong></p>
      <img class='swiper-lazy' src='/img/emoji/72/face-with-one-eyebrow-raised.png' alt=''> 
    </div>
     `,
      //sort_order: 24,
      updated_at: "2017-09-28T16:09:40.256Z",
    ...
    },
    {
      ...
      html_content: `
      <div class="my-auto">
        <p class='h2 green pb-5 bold'><strong>OHHHH...</strong></p>
        <img class='swiper-lazy w-20' src='/img/emoji/72/face-screaming-in-fear.png' alt=''> 
      </div>
      `,
      //sort_order: 26,
      updated_at: "2017-09-28T16:09:40.256Z",
    },
    {
      ...
      <div class="my-auto">
        <p class='h1 pb-0 mb-1 pink'>CSS</p>
        <p class='fs75 pb-4'>It works like this:</p>
        <p class='h5 pb-4'>If you have 100 pages <span class='pink bold'><strong>linking to the  same CSS</strong></span> styling…</p>
        <p class='h5 pb-4'>… all <span class='inline-code'>&lt;h3&gt;</span> tags across all 100 pages <span class='pink bold'><strong>will look the same<strong></span>.</p>
    ...
    },
    {
      ...
      <div class="my-auto">
        ...
        <img class='swiper-lazy' src='/img/emoji/72/shocked-face-with-exploding-head.png' alt=''> 
      </div> 
      `,
    ...
    },
    {
      ...
      <img class='swiper-lazy w-20 pr-2' src='/img/emoji/72/firecracker.png' alt=''> 
      <img class='swiper-lazy w-20 pr-2' src='/img/emoji/72/fire.png' alt=''> 
      <img class='swiper-lazy w-20' src='/img/emoji/72/firecracker.png' alt=''> 
    </div>
      `,
      //sort_order: 28,
      updated_at: "2017-09-28T16:09:40.256Z",
    ...
    <div class="my-auto">
      ...
      <img class='swiper-lazy w-20' src='/img/emoji/72/fish-cake-with-swirl-design.png' alt=''> 
    </div>
      `,
      //sort_order: 28,
      updated_at: "2017-09-28T16:09:40.256Z",
...

    {
      ...
      html_content: `
      <div class="my-auto">
        <p class='h2 green bold'><strong>READY?</strong></p>
      </div>
      `,
      //sort_order: 28,
      updated_at: "2017-09-28T16:09:40.256Z",
    ...
    <div class="my-auto">
      ...
      //sort_order: 29,
      tip: "Make sure your CSS  rule is in the style",
      updated_at: "2017-09-28T16:09:40.256Z",
    },
    {
      slide_number: 28,
    ...
    <div class="my-auto">
      ...
      <div class='html-code-box mb-3 bg-yellow black'>
        ...
        <p class='text-center' style="text-align: center;">text-align: center;</p>
        <p class='text-right mb-0' style="text-align: right;">text-align: right;</p>
      </div>
    ...
    },
    {
      ...
      html_content: `
      <div class="my-auto">
      <p class='h4 pb-5 w-75'>Let's have a<br><strong>PILLOW FIGHT</strong>!!!</p>
      <img class='swiper-lazy w-20' src='/img/emoji/72/smiling-face-with-open-mouth-and-tightly-closed-eyes.png' alt=''> 
    </div>
      `,
      updated_at: "2017-09-28T16:09:40.256Z",
    },
    {
      ...
      <div class='slide-footer tips text-left'>
        <div><span class='red'>TIP:</span> Just try. Checkpoint is coming soon.</div>
      </div> 
      `,
      reg: [
        {
      ...
      tip: "Just try. Checkpoint is coming soon.",
      updated_at: "2017-09-28T16:09:40.256Z",
    },{
      slide_number: 34,
      action: false,
    ...
    <div class="my-auto">
      ...
      <p class='h3 pb-5 text-left w-75 white'>Is all the content (text) on the  website centered?</p>
      <p class='pt-3 text-left w-75 white'>If not, then something’s  wrong.</p>
    ...
    },
    {
      ...
      <img class='swiper-lazy w-20' src='/img/emoji/72/flexed-biceps.png' alt=''> 
    </div> 
      `,
    ...
    <div class='slide-footer tips text-left'>
      ...
      },
      {
        ...
        `,
        tip: "The difference between margins and padding is the spacing for margins is outside of any defined borders",
        updated_at: "2017-09-28T16:09:40.256Z",
      },
    {  slide_number: 45,
      action: false,
    ...
    <div class='slide-footer tips text-left'>
      <div><span class='red'>TIP:</span> This is important if your site will be viewed on different screen sizes. Like on phones or laptops.
        ...
        `,
        tip: "This is important if your site will be viewed on different screen sizes. Like on phones or laptops.",
        updated_at: "2017-09-28T16:09:40.256Z",
      },
      {
        slide_number: 48,
      ...
      <div class="my-auto">
        ...
        <div>
      <p class='slide-header h2'>CHECKPOINT</p>
      <p class='fs75 w-75 white'>Your h3 selector should look  something like the below</p>
    </div>
    <div class="my-auto">
      <p class='fs75 pb-0 text-left'>Like this:</p>
      ...
      <img class='swiper-lazy' src='/img/emoji/72/crown.png' alt=''>
      </div>
        `,
        updated_at: "2017-09-28T16:09:40.256Z",
      },{
      ...
      },
      {
        ...
        <img class='pt-5 pl-2 w-20 swiper-lazy' src='/img/emoji/72/thinking-face.png' alt=''>
        <img class='pt-5 pl-2 w-20 swiper-lazy' src='/img/emoji/72/flushed-face.png' alt=''>
        <img class='pt-5 w-20 swiper-lazy' src='/img/emoji/72/flushed-face.png' alt=''> 
      </div>
        `,
        updated_at: "2017-09-28T16:09:40.256Z",
      },
      ...
      <img class='pt-5 w-20 swiper-lazy' src='/img/emoji/72/person-raising-both-hands-in-celebration-type-5.png' alt=''> 
      </div>
        `,
        updated_at: "2017-09-28T16:09:40.256Z",
      },{
      ...
      <img class='pt-5 pl-2 w-20 swiper-lazy' src='/img/emoji/72/party-popper.png' alt=''> 
      <img class='pt-5 pl-2 w-20 swiper-lazy' src='/img/emoji/72/party-popper.png' alt=''> 
      <img class='pt-5 pl-2 w-20 swiper-lazy' src='/img/emoji/72/party-popper.png' alt=''> 
    </div>
        `,
    ...
    <div>
      ...
      <p class='slide-header fs75 white'>WANT TO HAVE SOME FUN?</p>
    </div>
    <div class="my-auto">
      <p class='h3 pb-4'>Play with your border style.</p>
      <p class='pb-1 w-75'>Try these borders:</p>
      <div class='html-code-box mb-3 bg-white black text-center' style="text-align: center;"> 
        solid&nbsp;&nbsp;&nbsp;dotted<br>
        dashed&nbsp;&nbsp;&nbsp;double<br>
      </div> 
    </div> 
      ...
      <div class="my-auto">
        ...
        <img class='pt-5 pl-2 w-20 swiper-lazy' src='/img/emoji/72/man-dancing-type-4.png' alt=''> 
        <img class='pt-5 pl-2 w-20 swiper-lazy' src='/img/emoji/72/balloon.png' alt=''> 
        <img class='pt-5 pl-2 w-20 swiper-lazy' src='/img/emoji/72/dancer-type-6.png' alt=''> 
      </div>
        `,
        updated_at: "2017-09-28T16:09:40.256Z",
      },
...
export default lesson_dataC0001P001T004;
