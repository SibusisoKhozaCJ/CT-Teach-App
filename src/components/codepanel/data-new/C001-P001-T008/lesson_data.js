//P2Training4
const lesson_dataC0001P001T008 = {
  defaultCode: ``,
  kbLayout: "", 
  loadJS: "", 
  prevLessonID: "", 
  ...
  slides: [
    {
      ...
      <img class='pb-4 mt-4 w-20 swiper-lazy' src='/img/emoji/72/smiling-face-with-heart-shaped-eyes.png' alt=''>
      <img class='pb-4 mt-4 w-20 swiper-lazy' src='/img/emoji/72/smiling-face-with-heart-shaped-eyes.png' alt=''>
      <img class='pb-4 mt-4 w-20 swiper-lazy' src='/img/emoji/72/rainbow.png' alt=''>
    ...
    <p class='h5 pb-4 text-left'>We gonna be learning...</p>	
      ...
      <div class="my-auto">
        ...
        <img class='w-0 swiper-lazy' src='/img/lessons/C001-P002-T004/rgb-colors.PNG' alt=''>
      </div>       
        `,
      'created_at' : '',  
      'updated_at' : ''
      ...
      <div class="my-auto">
        <p class='h4 pb-4 blue'><strong>HTML Colors:</strong></p>
        <img class='w-0 swiper-lazy' src='/img/lessons/C001-P002-T004/rgb-blue.PNG' alt=''>
      ...
      <p class='h6pb-4'>EXAMPLE:</p>
        <img class='w-0 swiper-lazy' src='/img/lessons/C001-P002-T004/rgb-purple.PNG' alt=''>
      </div>
    ...
    <div class='html-code-box'>
      ...
      <div class='h5 text-left pb-3 my-auto'>
            <ul class=''>
      ...
      <div class='h1 pb-4 pink my-auto'>
       <strong>READY?</strong>
      </div>
        `,
      'created_at' : '',  
    ...
    <div class='slide-footer tips text-left'>
      ...
      reg: [
        {
          description: "Create a h3 selector.",
          rule: "((.|\n)\s*)(h3)((.|\n)*)\s*{((.|\n)*)\s*}((.|\n)*)\s*",
        },
      ],
      tip: "In <style> section.",
    }, { 
      slide_number: 13,
      action: true,
      challenge: true,
      ...
      <div>
        <div class='text-left pb-3'>
          <p class='blue text-uppercase'>Code:</p>
          <ul class='list-none'>
            <li class='tasks'>Add a background color to h3.</li>
          </ul>
        </div>
        <p class='fs75 pb-0 text-left'>Like this:</p>
        <div class='html-code-box'>
      ...
      reg: [
        {
          description: "Add a background color to h3.",
          rule: "((.|\n)\s*)(h3)((.|\n)*)\s*{((.|\n)*)\s*(background-color)((.|\n)*)\s*:((.|\n)*)\s*(#ce54c7;)((.|\n)*)\s*}((.|\n)*)\s*",
        },
      ],
      tip: "In <style> section.",
      ...
      <img class='pb-4 pt-4 swiper-lazy' src='/img/lessons/C001-P002-T004/padding.PNG' alt=''>
      </div>
        `,
      'created_at' : '',  
      'updated_at' : ''
      ...
      reg: [
        {
          description: "Add 15px of padding to h3.",
          rule: "((.|\n)\s*)(h3)((.|\n)*)\s*{((.|\n)*)\s*(background-color)((.|\n)*)\s*:((.|\n)*)\s*(#ce54c7;)((.|\n)*)\s*(padding)((.|\n)*)\s*:((.|\n)*)\s*(15px;)((.|\n)*)\s*}((.|\n)*)\s*",
        },
      ],
      ...
      reg: [
        {
          description: "Increase the h3 font-size with em.",
          rule: "((.|\n)\s*)(h3)((.|\n)*)\s*{((.|\n)*)\s*(background-color)((.|\n)*)\s*:((.|\n)*)\s*(#ce54c7;)((.|\n)*)\s*(padding)((.|\n)*)\s*:((.|\n)*)\s*(15px;)((.|\n)*)\s*(font-size)((.|\n)*)\s*:((.|\n)*)\s*(1.5em;)((.|\n)*)\s*}((.|\n)*)\s*",
        },
      ],
      updated_at: "2017-09-28T16:09:40.256Z",
      ...
      reg: [
        {
          description: "Add a left-border with this color: &#35;d6d6cd.",
          rule: "((.|\n)\s*)(h3)((.|\n)*)\s*{((.|\n)*)\s*(background-color)((.|\n)*)\s*:((.|\n)*)\s*(#ce54c7;)((.|\n)*)\s*(padding)((.|\n)*)\s*:((.|\n)*)\s*(15px;)((.|\n)*)\s*(font-size)((.|\n)*)\s*:((.|\n)*)\s*(1.5em;)((.|\n)*)\s*(border-left)((.|\n)*)\s*:((.|\n)*)\s*(10px)((.|\n)*)\s*(solid)((.|\n)*)\s*(#d6d5cd);((.|\n)*)\s*}((.|\n)*)\s*",
        },
      ],
      updated_at: "2017-09-28T16:09:40.256Z",
      ...
      'html_content' : `
    <div class="my-auto">
        <p class="h2 pb-4 aqua text-uppercase bold"><strong>SUPER COOL!</strong></p> 
    ...
    <div class="my-auto">
      ...
      <img class='swiper-lazy' src='/img/emoji/72/grinning-face-with-one-large-and-one-small-eye.png' alt=''> 
    ...
    <div class='html-code-box'>
      ...
      <img class='swiper-lazy' src='/img/emoji/72/smiling-face-with-heart-shaped-eyes.png' alt=''> 
      </div>
      `,
      'created_at' : '',  
      'updated_at' : ''
      ...
      reg: [
        {
          description: "Make both <heder> and <h3> white using a single CSS element.",
          rule: "((.|\n)\s*)(header)((.|\n)*)\s*(\,)((.|\n)*)\s*(h3)((.|\n)*)\s*{((.|\n)*)\s*(color)((.|\n)*)\s*(:)((.|\n)*)\s*(white)((.|\n)*)\s*(;)((.|\n)*)\s*}((.|\n)*)\s*",
        },
      ],
      updated_at: "2017-09-28T16:09:40.256Z",
      ...
      <img class='pb-4 pt-4 swiper-lazy' src='/img/lessons/C001-P002-T004/fonts-graphic.png' alt=''>
      </div>
        `,
      'created_at' : '',  
      'updated_at' : ''
      ...
      <img class='pb-4 pt-4 swiper-lazy' data-src='/img/lessons/C001-P002-T004/fonts-graphic-2.png' alt=''>
      </div>
        `,
      'created_at' : '',  
      'updated_at' : ''
    ...
    <div  class="my-auto">
      ...
      reg: [
        {
          description: "Use Helvetica, Arial and Sans-Serif as font family for body.",
          rule: "((.|\n)\s*)(body)((.|\n)*)\s*({)((.|\n)*)\s*(font-family)((.|\n)*)\s*(:)((.|\n)*)\s*(helvetica)((.|\n)*)\s*(,)((.|\n)*)\s*(arial)((.|\n)*)\s*(,)((.|\n)*)\s*(san-serif)((.|\n)*)\s*(;)((.|\n)*)\s*}((.|\n)*)\s*",
        },
      ],
      updated_at: "2017-09-28T16:09:40.256Z",
      ...
      reg: [
        {
          description: ">Add Arial, Gadget, and San-Serif as font-family for header and h3.",
          rule: "((.|\n)\s*)(header)((.|\n)*)\s*(\,)((.|\n)*)\s*(h3)((.|\n)*)\s*{((.|\n)*)\s*(color)((.|\n)*)\s*(:)((.|\n)*)\s*(white)((.|\n)*)\s*(;)((.|\n)*)\s*(font-family)((.|\n)*)\s*(:)((.|\n)*)\s*(\"Arial Black\")((.|\n)*)\s*(,)((.|\n)*)\s*(Gadget)((.|\n)*)\s*(,)((.|\n)*)\s*(sans-serif)((.|\n)*)\s*(;)((.|\n)*)\s*}((.|\n)*)\s*body((.|\n)*)\s*{((.|\n)*)\s*font-family((.|\n)*)\s*",
        },
      ],
      updated_at: "2017-09-28T16:09:40.256Z",
      ...
      <div class="my-auto">
        ...
        <img class='w-0 swiper-lazy' src='/img/lessons/C001-P002-T004/screen-size.PNG' alt=''>
      </div>       
        `,
      'created_at' : '',  
      'updated_at' : ''
      ...
      'html_content' : `
    <div class="my-auto">
        <p class="h2 pb-4 aqua text-uppercase bold"><strong>GOOD.</strong><p> 
      ...
      <img class='w-0 swiper-lazy pb-4' src='/img/lessons/C001-P002-T004/pixels.PNG' alt=''>
      ...
      <img class='w-0 swiper-lazy pb-4' src='/img/lessons/C001-P002-T004/screen-pixels.PNG' alt=''>
      </div>       
        `,
      'created_at' : '',  
      'updated_at' : ''
      ...
      'html_content' : `
    <div class="my-auto">
        <p class="h2 pb-4 aqua text-uppercase bold"><strong>YOU'RE DOING AMAZING.</strong><p> 
      ...
      'html_content' : `
        ...
        <div class="my-auto">
          ...
          <img class='w-0 swiper-lazy pb-4' src='/img/lessons/C001-P002-T004/screen-size-50.PNG' alt=''>
        </div>
        `,
      'created_at' : '',  
      'updated_at' : ''
    ...
    <div class="my-auto">
      ...
      <a class='btn btn-encouraging next check' data-click="gt:/codepanel/C001/P002/T005" style='width: 80%;' href='#'>Start Now</a>
...
export default lesson_dataC0001P001T008;
