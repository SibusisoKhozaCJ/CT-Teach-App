//P2Training3
const lesson_dataC0001P001T007 = {
  defaultCode: ``,
  kbLayout: "", 
  loadJS: "", 
  prevLessonID: "P2Training2", 
  nextLessonSlug: "", 
  pageDesc:
  ...
  slides: [
    {
      ...
      <div class="my-auto">
        <p class='h2 pb-4 aqua text-uppercase bold'><strong>OMG</strong></p>
        <p class='h4'>This is a SUPER FUN Lesson</p>
      <img class='mt-4 w-20 swiper-lazy' src='/img/emoji/72/grinning-face-with-star-eyes.png' alt=''>
      <img class='mt-4 w-20 swiper-lazy' src='/img/emoji/72/grinning-face-with-star-eyes.png' alt=''>
      <img class='mt-4 w-20 swiper-lazy' src='/img/emoji/72/grinning-face-with-star-eyes.png' alt=''>
    ...
    <div class="my-auto">       
      ...
      <img class='mt-4 w-20 swiper-lazy' src='/img/emoji/72/high-voltage-sign.png' alt=''>
      <img class='mt-4 w-20 swiper-lazy' src='/img/emoji/72/high-voltage-sign.png' alt=''>
      <img class='mt-4 w-20 swiper-lazy' src='/img/emoji/72/high-voltage-sign.png' alt=''>
      <p class='h3 pt-4 pb-'>You decided you wanted...</p>
      <img class='mt-4 mb-4 w-20 swiper-lazy' src='/img/emoji/72/package.png' alt=''>
      ...
      <img class='swiper-lazy w-50' src='/img/lessons/C001-P002-T003/box-dimensions.PNG' alt=''>
     ...
     <img class='swiper-lazy' src='/img/emoji/72/smiling-face-with-sunglasses.png' alt=''> 
      ...
      <div class="my-auto">
        <div class='text-left pb-3'>
          ...
          <ol class="list-numbered">
            ...
            <li class='tasks'>Make it 250px wide & height.</li>
          </ol>
        </div>
      ...
      reg: [
        {
          description: "Make a .box css class.",
          rule: "((.|\n)\s*)(.box)((.|\n)*)\s*{((.|\n)*)\s*(height)((.|\n)*)\s*:((.|\n)*)\s*250px;((.|\n)*)\s*width((.|\n)*)\s*:((.|\n)*)\s*250px;((.|\n)*)\s*",
        },
      ],
      ...
      reg: [
        {
          description: "Make a <div> in the <header> section above <h1> and add the .box class to the <div>",
          rule: "((.|\n)*)\s*(<div((.)*)\s* class=\"box\"((.|\n)*)\s*>)((.|\n)*)\s*(<\/div>)((.|\n)*)\s*(<h1>)",
        },
      ],
      updated_at: "2017-09-28T16:09:40.256Z",
      ...
      reg: [
        {
          description: "Add this code to the .box class.",
          rule: "((.|\n)\s*)(.box)((.|\n)*)\s*{((.|\n)*)\s*(height)((.|\n)*)\s*:((.|\n)*)\s*250px;((.|\n)*)\s*width((.|\n)*)\s*:((.|\n)*)\s*250px;((.|\n)*)\s*background((.|\n)*)\s*:((.|\n)*)\s*blue;((.|\n)*)\s*",
        },
      ],
      updated_at: "2017-09-28T16:09:40.256Z",
    ...
    &nbsp;&lt;style&gt;<br>
      ...
      'html_content' : `
      <div class="my-auto">
        <p class='h3 green pb-4 bold'><strong>WOW</strong></p>
        <p class='h4 pb-4'>You are on</p>
        <img class='swiper-lazy' src='/img/emoji/72/fire.png' alt=''> 
        <img class='swiper-lazy' src='/img/emoji/72/fire.png' alt=''> 
        <img class='swiper-lazy' src='/img/emoji/72/fire.png' alt=''> 
      </div>
        `,
      ...
      <div class='h4 pb-4'>What's a <strong>DIV</strong>?</div>
        <img style="width:35%" class='mt-4 mb-4 swiper-lazy' src='/img/lessons/C001-P002-T003/briefcase.png' alt=''>
      ...
      <div class="my-auto">
        <div class='h3 pb-4'>Did you enjoy making a box?</div>
         <img class='swiper-lazy pb-4 pt-4' src='/img/emoji/72/smiling-face-with-sunglasses.png' alt=''> 
      ...
      <div class="my-auto">
        <div class='h3 pb-4'>With one line of code we are going to turn the box into a circle.</div>
         <img class='swiper-lazy pb-4 pt-4' src='/img/emoji/72/weary-cat-face.png' alt=''> 
         <img class='swiper-lazy pb-4 pt-4' src='/img/emoji/72/weary-cat-face.png' alt=''> 
         <img class='swiper-lazy pb-4 pt-4' src='/img/emoji/72/weary-cat-face.png' alt=''> 
      ...
      <div class="my-auto">
        ...
        <img style="width:55%" class='mt-4 mb-4 swiper-lazy' src='/img/lessons/C001-P002-T003/50-radius.PNG' alt=''>
        <p class="h5 pb-4">or add rounded corners. (5%)</p>
        <img style="width:80%" class='mt-4 mb-4 swiper-lazy' src='/img/lessons/C001-P002-T003/5-radius.PNG' alt=''>
      </div>
      ...
      reg: [
        {
          description: "Add a border-radius to .box class with a value of 50%.",
          rule: "((.|\n)*)\s*width((.|\n)*)\s*:((.|\n)*)\s*250px;((.|\n)*)\s*background((.|\n)*)\s*:((.|\n)*)\s*blue;((.|\n)*)\s*border-radius((.|\n)*)\s*:((.|\n)*)\s*50%;((.|\n)*)\s*",
        },
      ],
      updated_at: "2017-09-28T16:09:40.256Z",
      ...
      reg: [
        {
          description: "Change CSS class .box to .circle",
    ...
    &nbsp;&lt;style&gt;<br>
      ...
      'html_content' : `
      <div class="my-auto">
        <p class='h3 green pb-4 bold'><strong>COOL</strong></p>
      ...
      reg: [
        {
          description: "Add a solid, 10px wide, white border to the .circle to CSS class.",
          rule: "((.|\n)*)\s*width((.|\n)*)\s*:((.|\n)*)\s*250px;((.|\n)*)\s*background((.|\n)*)\s*:((.|\n)*)\s*blue;((.|\n)*)\s*border-radius((.|\n)*)\s*:((.|\n)*)\s*50%;((.|\n)*)\s*border((.|\n)*)\s*:((.|\n)*)\s*10px((.|\n)*)\s*solid((.|\n)*)\s*white;((.|\n)*)\s*",
        },
      ],
      updated_at: "2017-09-28T16:09:40.256Z",
      ...
      reg: [
        {
          description: "Add to the circle class.",
          rule: "((.|\n)*)\s*.circle((.|\n)*)\s*{((.|\n)*)\s*display((.|\n)*)\s*:((.|\n)*)\s*inline-block;",
        },
      ],
      tip: "In .circle{ }",
      ...
      'html_content' : `
      <div class="my-auto">
        <p class='h3 green pb-4 bold'><strong>GREAT!</strong></p>
    ...
    <div class='html-code-box'>
      ...
      <img class='pt-5 swiper-lazy' src='/img/emoji/72/female-technologist-type-4.png' alt=''>
      <img class='pt-5 swiper-lazy' src='/img/emoji/72/male-technologist-type-6.png' alt=''> 
      <img class='pt-5 swiper-lazy' src='/img/emoji/72/female-technologist-type-3.png' alt=''>
      ...
      <div class="my-auto">
        ...
        <p class='h5'><img style="padding-top: 0 !important;" class='pt-5 swiper-lazy' src='/img/emoji/72/rainbow.png' alt=''> = Hint</p>
      ...
      <a class='btn btn-encouraging next check' data-click="gt:/codepanel/C001/P002/T004" style='width: 80%;' href='#'>Start Now</a>
...
export default lesson_dataC0001P001T007;
