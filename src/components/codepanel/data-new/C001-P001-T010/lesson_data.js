//P2Training6
const lesson_dataC0001P001T010 = {
  defaultCode: ``,
  kbLayout: "", 
  loadJS: "", 
  prevLessonID: "P2Training5", 
  nextLessonSlug: "", 
  pageDesc:
  ...
  slides: [
    {
      ...
      <div class="my-auto">
        ...
        <img class='swiper-lazy mt-1 m-b1' src='/img/emoji/72/emoji-1.png' alt=''> 
        <img class='swiper-lazy mt-1 m-b1' src='/img/emoji/72/emoji-2.png' alt=''>
        <img class='swiper-lazy mt-1 m-b1' src='/img/emoji/72/emoji-3.png' alt=''> 
        <img class='swiper-lazy mt-1 m-b1' src='/img/emoji/72/emoji-4.png' alt=''> 
        <img class='swiper-lazy mt-1 m-b1' src='/img/emoji/72/emoji-2.png' alt=''>  
        <img class='swiper-lazy mt-1 m-b1' src='/img/emoji/72/emoji-1.png' alt=''> 
        <img class='swiper-lazy mt-1 m-b1' src='/img/emoji/72/emoji-4.png' alt=''> 
      </div>      
    ...
    {      
      ...
      'html_content' : `
            ...
            <div class="my-auto">      
          <strong class='h3'><strong>Emojies</strong><br>
          </div>
          <div>
    ...
    <div class="my-auto">
      ...
      <img class='swiper-lazy mt-1 m-b1' src='/img/emoji/72/emoji-7.png' alt=''> 
      <img class='swiper-lazy mt-1 m-b1' src='/img/emoji/72/emoji-8.png' alt=''> 
      <img class='swiper-lazy mt-1 m-b1' src='/img/emoji/72/emoji-7.png' alt=''> 
    ...
    <div class="my-auto">
      ...
      <img class='swiper-lazy mt-1 m-b1' src='/img/emoji/72/emoji-5.png' alt=''> 
      <img class='swiper-lazy mt-1 m-b1' src='/img/emoji/72/emoji-5.png' alt=''> 
      <p class='h4 pt-1  mt-2 text-center '>And you can release it if you know it.</p>
      <img class='swiper-lazy mt-1 m-b1' src='/img/emoji/72/emoji-6.png' alt=''> 
      <img class='swiper-lazy mt-1 m-b1' src='../img/emoji/72/emoji-6.png' alt=''> 
      ...
      <div class="my-auto">
       ...
       <div class="example-box">
        <p class="h3">  <img class='swiper-lazy' src='/img/emoji/72/smiling-face-with-sunglasses.png' alt=''> = <span class="pink">#</span>x1F60E</p>
       </div>
       <div>    
        `,
      'created_at' : '',  
    ...
    <div class="my-auto">
     ...
     <p class='pb-4 text-left'>Example:</p>
     <div class="example-box">
     <p class="h3">  <img class='swiper-lazy' src='/img/emoji/72/smiling-face-with-sunglasses.png' alt=''> = <strong><span class="pink">&</span></strong>#x1F60E</p>
     </div>
     <div>
        `,
      'created_at' : '',  
    ...
    {          
      ...
      <div>
        <p class='h3 pb-4 text-left'>1. Add a big emoji in a new <span class="inline-code">&lt;div&gt;</span>.</p>
        <p class='h3 pb-4 text-left'>2. Style it with class .emoji ,</p>
        <p class='h1 dots'>...</p>
      </div>
    ...
    <p class='fs75 pb-0 text-left'>Like this:</p>
      ...
      reg: [
        {
          description: "Add a new div.",
          rule: "((.|\n)*)\s*<div((.|\n)*)\s*class=\"((.|\n)*)\s*circle((.|\n)*)\s*\"((.|\n)*)\s*>((.|\n)*)\s*<div((.|\n)*)\s*>((.|\n)*)\s*((.|\n)*)\s*<\/div((.|\n)*)\s*>((.|\n)*)\s*<\/div((.|\n)*)\s*>((.|\n)*)\s*",
        },
      ],
      tip:'Inside the <div class= "circle">',
    }, { 
      slide_number: 13,
      action: true,
      challenge: true,
      ...
      reg: [
        {
          description: "Place an emoji into the new <div> Use this one: #x1F60E;",
          rule: "((.|\n)*)\s*<div((.|\n)*)\s*class=\"((.|\n)*)\s*circle((.|\n)*)\s*\"((.|\n)*)\s*>((.|\n)*)\s*<div((.|\n)*)\s*>((.|\n)*)\s*&#x1F60E((.|\n)*)\s*<\/div((.|\n)*)\s*>((.|\n)*)\s*<\/div((.|\n)*)\s*>((.|\n)*)\s*",
        },
      ],
  ...
  { 
    ...
    reg: [
      {
        description: "Create a new CSS Class: .emoji and increase the font size to 8 em.",
        rule: "((.|\n)\s*)<style>((.|\n)*)\s*(.emoji)((.|\n)*)\s*{((.|\n)*)\s*(font-size)((.|\n)*)\s*:((.|\n)*)\s*(8em;)((.|\n)*)\s*}((.|\n)*)\s*<\/style>((.|\n)*)\s*",
      },
    ],
    updated_at: "2017-09-28T16:09:40.256Z",
      ...
      reg: [
        {
          description: "Link the .emoji class to the new <div>;.",
          rule: "((.|\n)*)\s*<div((.|\n)*)\s*class=\"((.|\n)*)\s*circle((.|\n)*)\s*\"((.|\n)*)\s*>((.|\n)*)\s*<div((.|\n)*)\s*class=\"((.|\n)*)\s*emoji((.|\n)*)\s*\"((.|\n)*)\s*>((.|\n)*)\s*&#x1F60E((.|\n)*)\s*<\/div((.|\n)*)\s*>((.|\n)*)\s*<\/div((.|\n)*)\s*>((.|\n)*)\s*",
        },
      ],
      updated_at: "2017-09-28T16:09:40.256Z",
    ...
    { 
      ...
      reg: [
        {
          description: "Insert an emoji before your h3 text.",
          rule: "((.|\n)\s*)<h3>((.|\n)*)\s*(&#9737)((.|\n)*)\s*(DETAILS)((.|\n)*)\s*<\/h3>((.|\n)*)\s*<p>((.|\n)*)\s*<\/p>((.|\n)*)\s*",
        },
      ],
      updated_at: "2017-09-28T16:09:40.256Z",
    ...
    { 
      ...
      reg: [
        {
          description: "Here are suggested ones of the rest:",
          rule: "((.|\n)\s*)<h3>((.|\n)*)\s*(&#[0-9][0-9][0-9][0-9])((.|\n)*)\s*(ABOUT ME)((.|\n)*)\s*<\/h3>((.|\n)*)\s*<p>((.|\n)*)\s*<\/p>((.|\n)*)\s*",
        },
      ],
      updated_at: "2017-09-28T16:09:40.256Z",
  ...
  
    {
      ...
      <tbody>
        <tr class="egg-yellow">
          <td class="border-right"><img class='swiper-lazy mt-1 m-b1' src='/img/emoji/72/si1.png' alt=''> </td>
          <td>9749</td>
        </tr>
        <tr class="light-yellow">
          <td class="border-right"><img class='swiper-lazy mt-1 m-b1' src='/img/emoji/72/si2.png' alt=''></td>
          <td>9835</td>
        </tr>
        <tr class="egg-yellow">
          <td class="border-right"><img class='swiper-lazy mt-1 m-b1' src='/img/emoji/72/si3.png' alt=''></td>
          <td>9734</td>
        </tr>
        <tr class="light-yellow">
          <td class="border-right"><img class='swiper-lazy mt-1 m-b1' src='/img/emoji/72/si4.png' alt=''></td>
          <td>9728</td>
        </tr>
        <tr class="egg-yellow">
          <td class="border-right"><img class='swiper-lazy mt-1 m-b1' src='/img/emoji/72/si5.png' alt=''></td>
          <td>9786</td>
        </tr>
        <tr class="light-yellow">
          <td class="border-right"><img class='swiper-lazy mt-1 m-b1' src='/img/emoji/72/si6.png' alt=''></td>
          <td>9917</td>
        </tr>
        <tr class="egg-yellow">
          <td class="border-right"><img class='swiper-lazy mt-1 m-b1' src='/img/emoji/72/si7.png' alt=''></td>
          <td>10048</td>
        </tr>
        <tr class="light-yellow">
          <td class="border-right"><img class='swiper-lazy mt-1 m-b1' src='/img/emoji/72/si8.png' alt=''></td>
          <td>9748</td>
        </tr>
        <tr class="egg-yellow">
          <td class="border-right"><img class='swiper-lazy mt-1 m-b1' src='/img/emoji/72/si9.png' alt=''></td>
          <td>infine;</td>
        </tr>
        <tr class="light-yellow">
          <td class="border-right"><img class='swiper-lazy mt-1 m-b1' src='/img/emoji/72/si10.png' alt=''></td>
          <td>10140</td>
        </tr>
      </tbody>
    </table>
    ...
    { 
      ...
      reg: [
        {
          description: "Add list-style: none; to the p, ul CSS. This removes the black bullet-points.",
          rule: "((.|\n)\s*)<style>((.|\n)*)\s*(p)((.|\n)*)\s*(,)((.|\n)*)\s*(ul)((.|\n)*)\s*{((.|\n)*)\s*(list-style)((.|\n)*)\s*:((.|\n)*)\s*(none)((.|\n)*)\s*;((.|\n)*)\s*(padding-left)((.|\n)*)\s*:((.|\n)*)\s*(50px)((.|\n)*)\s*;((.|\n)*)\s*(font-size)((.|\n)*)\s*:((.|\n)*)\s*(1.3em)((.|\n)*)\s*;((.|\n)*)\s*}((.|\n)*)\s*<\/style>((.|\n)*)\s*",
        },
      ],
      updated_at: "2017-09-28T16:09:40.256Z",
    ...
    { 
      ...
      reg: [
        {
          description: "Add &#9898 in front of each item list",
          rule: "((.|\n)\s*)<li>((.|\n)*)\s*(&#9898)((.|\n)*)\s*<\/li>",
        },
      ],
      updated_at: "2017-09-28T16:09:40.256Z",
    ...
    <div class="my-auto">
     ...
     <p class='pb-4 text-left'>Example:</p>
     <div class="example-box">
      <p class="h3">  <img class='swiper-lazy' src='/img/emoji/72/si21.png' alt=''> = <span class="pink">&</span>copy</p>
     </div>
     <div> 	
        `,
      'created_at' : '',  
    ...
    <span class="disable">&lt;body&gt;</span>
      ...
      reg: [
        {
          description: "Add a copyright lineat the end of your website right before </body>;.",
          rule: "((.|\n)*)\s*<br>((.|\n)*)\s*(&copy;)((.|\n)*)\s*Copyright((.|\n)*)\s*[0-9][0-9][0-9][0-9]((.|\n)*)\s*[a-z][a-z]((.|\n)*)\s*<\/body>((.|\n)*)\s*",
        },
      ],
      updated_at: "2017-09-28T16:09:40.256Z",
    ...
    { 
      ...
      reg: [
        {
          description: "Add <center> tags around your copyright text.",
          rule: "((.|\n)*)\s*<center>((.|\n)*)\s*(&copy)((.|\n)*)\s*Copyright((.|\n)*)\s*[0-9][0-9][0-9][0-9]((.|\n)*)\s*[a-z][a-z]((.|\n)*)\s*<\/center>((.|\n)*)\s*<\/body>((.|\n)*)\s*",
        },
      ],
      updated_at: "2017-09-28T16:09:40.256Z",
    ...
    {   
      ...
      <p class="fs75 white">Your code should look like this:</p>
      </div>
      <div class="my-auto">
    <div class='html-code-box'>
...
export default lesson_dataC0001P001T010;
