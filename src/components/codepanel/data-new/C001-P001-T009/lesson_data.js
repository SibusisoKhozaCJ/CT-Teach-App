//P2Training5
const lesson_dataC0001P001T009 = {
  defaultCode: ``,
  kbLayout: "", 
  loadJS: "", 
  prevLessonID: "", 
  ...
  slides: [
    {
      ...
      'html_content' : `
    <div class='my-auto'>
        <p class="h2 pb-4 aqua text-uppercase bold"><strong>OK.</strong><p> 
   ...
   &nbsp;&nbsp;ABOUT ME<br>
    ...
    <div class='slide-footer tips text-left'>
      ...
      reg: [
        {
          description: "Add an h3 with an ABOUT ME section.",
          rule: "((.|\n)\s*)<h3>((.|\n)*)\s*(ABOUT ME)((.|\n)*)\s*<\/h3>((.|\n)*)\s*",
        },
      ],
      tip:"Below the DETAILS section.",
    }, { 
      slide_number : 9,   
      action : false,
      challenge : false,
    ...
    <p class='h4 pt-3 text-left aqua'>WRITE:</p>
      ...
      <div class='text-left pb-3'>
        <p class='blue text-uppercase'>Code:</p>
        <ul class='list-none'>
          <li class='tasks'>Write about yourself in a <span class="html-code">&lt;p&gt;</span>.</li>
        </ul>
      </div>
      <p class='fs75 pb-0 text-left'>Like this:</p>
      <div class='html-code-box'>
    ...
    <div class='slide-footer tips text-left'>
      ...
      reg: [
        {
          description: "Write about yourself in a <p>.",
          rule: "((.|\n)\s*)<h3>((.|\n)*)\s*(ABOUT ME)((.|\n)*)\s*<\/h3>((.|\n)*)\s*<p>((.|\n)*)\s*[a-z][a-z][a-z]((.|\n)*)\s*<\/p>((.|\n)*)\s*",
        },
      ],
      tip:"You can add different lines by making a new <p> for each line.",
    }, {   
      slide_number : 11,   
      action : false,
      challenge : false,
      ...
      'html_content' : `
      <div class="my-auto">
        <p class="h2 pb-4 aqua text-uppercase bold"><strong>GREAT.</strong><p> 
      ...
      <div>
        <div class='text-left pb-3'>
          <p class='blue text-uppercase'>Code:</p>
          <ul class='list-none'>
            <li class='tasks'>Add an h3 "EDUCATION" section. Add the text in a few <span class="html-code">&lt;p&gt;</span>s.</li>
          </ul>
        </div>
        <p class='fs75 pb-0 text-left'>Like this:</p>
        <div class='html-code-box'>
      ...
      reg: [
        {
          description: "Add an h3 EDUCATION section. Add the text in a few <p>s.",
          rule: "((.|\n)\s*)<h3>((.|\n)*)\s*(EDUCATION)((.|\n)*)\s*<\/h3>((.|\n)*)\s*<p>((.|\n)*)\s*[a-z][a-z][a-z]((.|\n)*)\s*<\/p>((.|\n)*)\s*",
        },
      ],
      ...
      <div>
        <div class='text-left pb-3'>
          <p class='blue text-uppercase'>Code:</p>
          <ul class='list-none'>
            <li class='tasks'>Add an "EXPERIENCES" section. You can write about anything you want in the <span class="inline-code">&lt;p&gt;</span>.</li>
          </ul>
        </div>
        <p class='fs75 pb-0 text-left'>Like this:</p>
        <div class='html-code-box'>
      ...
      reg: [
        {
          //description: "Add an EXPERIENCES section. You can write about anything you want in the <p>.",
          rule: "((.|\n)\s*)<h3>((.|\n)*)\s*(EXPERIENCES)((.|\n)*)\s*<\/h3>((.|\n)*)\s*<p>((.|\n)*)\s*[a-z][a-z][a-z]((.|\n)*)\s*<\/p>((.|\n)*)\s*",
        },
      ],
      tip: "You can add different lines by making a new <p> for each line.",
      ...
      <img class='swiper-lazy' src='/img/emoji/72/female-technologist-type-4.png' alt=''> 
      ...
      'html_content' : `
      <div class="my-auto">
        <p class="h2 pb-4 aqua text-uppercase bold"><strong>FANTASTIC!</strong><p> 
      ...
      reg: [
        {
          description: "Add a SKILLS section.",
          rule: "((.|\n)\s*)<h3>((.|\n)*)\s*(SKILLS)((.|\n)*)\s*<\/h3>((.|\n)*)\s*<ul>((.|\n)*)\s*<li>((.|\n)*)\s*[a-z][a-z][a-z]((.|\n)*)\s*<\/li>((.|\n)*)\s*<\/ul>((.|\n)*)\s*",
        },
      ],
      tip: "You can add different lines by making a new <p> for each line.",
      ...
      <img class='swiper-lazy' src='/img/emoji/72/speak-no-evil-monkey.png' alt=''> 
      </div>
      `,
      'created_at' : '',  
      'updated_at' : ''
      ...
      <img class='swiper-lazy' src='/img/emoji/72/eyes.png' alt=''> 
      </div>
      `,
      'created_at' : '',  
      'updated_at' : ''
      ...
      reg: [
        {
          description: "Provide some padding and increase size of <ul> and <p>.",
          rule: "((.|\n)\s*)(p)((.|\n)*)\s*(,)((.|\n)*)\s*(ul)((.|\n)*)\s*({)((.|\n)*)\s*(})((.|\n)*)\s*",
        },
      ],
      updated_at: "2017-09-28T16:09:40.256Z",
      ...
      reg: [
        {
          description: "Try 50px of padding on the left only.",
          rule: "((.|\n)\s*)(p)((.|\n)*)\s*(,)((.|\n)*)\s*(ul)((.|\n)*)\s*({)((.|\n)*)\s*padding-left:((.|\n)*)\s*50px((.|\n)*)\s*;((.|\n)*)\s*(})((.|\n)*)\s*",
        },
      ],
      updated_at: "2017-09-28T16:09:40.256Z",
      ...
      reg: [
        {
          description: "Increase the size of these selectors by 30%.",
          rule: "((.|\n)\s*)(p)((.|\n)*)\s*(,)((.|\n)*)\s*(ul)((.|\n)*)\s*({)((.|\n)*)\s*padding-left:((.|\n)*)\s*50px((.|\n)*)\s*;((.|\n)*)\s*font-size:((.|\n)*)\s*1.3em((.|\n)*)\s*;((.|\n)*)\s*(})((.|\n)*)\s*",
        },
      ],
      updated_at: "2017-09-28T16:09:40.256Z",
      ...
      'html_content' : `
      <div class="my-auto">
        <p class="h2 pb-4 aqua text-uppercase bold"><strong>GREAT JOB!</strong><p> 
      ...
      'html_content' : `
      <div class="my-auto">
        <p class="h2 pb-4 pink text-uppercase bold"><strong>ALMOST DONE.</strong><p>
       <p class='h3 pb-5 w-75'>Add a "CONTACT" section.</p>
      <img class='swiper-lazy' src='/img/emoji/72/house-building.png' alt=''>
      <img class='swiper-lazy' src='/img/emoji/72/mobile-phone.png' alt=''>
      <img class='swiper-lazy' src='/img/emoji/72/e-mail-symbol.png' alt=''>
      </div>
      `,
      'created_at' : '',  
      'updated_at' : ''
   ...
   Add a phone number and email too.
      ...
      'html_content' : `
      <div class="my-auto">
        <p class="h2 pb-4 aqua text-uppercase bold"><strong>DONE!</strong><p>
      ...
      <a class='btn btn-encouraging next check' data-click="gt:/codepanel/C001/P002/T006" style='width: 80%;' href='#'>Start Now</a>
...
export default lesson_dataC0001P001T009;
