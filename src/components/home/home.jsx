  ...
  return (
    <div>
      ...
      {/* <Typography>
        ...
        codetribe site. The portal, which you are currently in, is where you can
        do things like view past questionnaires, maybe update your profile
        information or even request more services.{"\n\n"}
        The navigation "hambruger" at the top right of the screen has all of the
