...
const ReactPageScroller = ({
  ...
  useEffect(() => {
    ...
    scrollContainer.current.addEventListener(Events.TOUCHSTART, touchStart);
    scrollContainer.current.addEventListener(Events.TOUCHEND, touchEnd);
    ...
    return () => {
      ...
      scrollContainer.current.removeEventListener(Events.TOUCHSTART, touchStart);
      scrollContainer.current.removeEventListener(Events.TOUCHEND, touchEnd);
